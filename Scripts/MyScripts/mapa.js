...
mapboxgl.accessToken = 'pk.eyJ1IjoibGF6YXJvc2EiLCJhIjoiY2szenRpdWJ4MWQ1cjNkcDd6dmI4d3dwNCJ9.m9NR7CIlzQ8hNjj1qZ5jkw';
var map = new mapboxgl.Map({
    container: 'map', // container id
    style: 'mapbox://styles/mapbox/streets-v11', // stylesheet location
    center: [parseFloat(longitud), parseFloat(latitud)], // starting position [lng, lat]
    zoom: 13.5,
    pitch: 45,
    bearing: -17.6,
    antialias: true
